...
import com.example.animeapp.ui.theme.ShimmerDarkGray
import com.example.animeapp.ui.theme.ShimmerLightGray
import com.example.animeapp.ui.theme.ShimmerMediumGray
...
@Preview
@Composable
fun ShimmerEffectPreviewLight(){
    AnimatedShimmerItem()
}
@Preview(uiMode = UI_MODE_NIGHT_YES)
@Composable
fun ShimmerEffectPreviewDark(){
    AnimatedShimmerItem()
}
